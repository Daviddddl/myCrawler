...
#     start_urls = 'http://www.diseasesdatabase.com/item_choice.asp?strUserInput='+each_disease+'&bytSearchType=0'
#     print('\''+start_urls+'\',')

url = 'http://www.diseasesdatabase.com/item_choice.asp?strUserInput=Oral%20disorders&bytSearchType=0'
print(parse.unquote(re.search(r'(strUserInput=)(.*)(&bytSearchType=0)', url).group(2)))
